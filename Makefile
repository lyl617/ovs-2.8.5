...
ACLOCAL = ${SHELL} /home/jsen/ovs/openvswitch-2.8.5/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/jsen/ovs/openvswitch-2.8.5/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/jsen/ovs/openvswitch-2.8.5/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/jsen/ovs/openvswitch-2.8.5/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/jsen/ovs/openvswitch-2.8.5/build-aux/missing automake-1.14
AWK = mawk
CAPNG_LDADD = 
...
KARCH = 
KBUILD = /lib/modules/4.4.0-31-generic/build
...
LT_CURRENT = 0
LT_REVISION = 0
MAKEINFO = ${SHELL} /home/jsen/ovs/openvswitch-2.8.5/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
OVS_LDFLAGS = 
OVS_LTINFO = -release 2.8 -version-info 0:5
PACKAGE = openvswitch
PACKAGE_BUGREPORT = bugs@openvswitch.org
PACKAGE_NAME = openvswitch
PACKAGE_STRING = openvswitch 2.8.5
...
abs_builddir = /home/jsen/ovs/openvswitch-2.8.5
abs_srcdir = /home/jsen/ovs/openvswitch-2.8.5
abs_top_builddir = /home/jsen/ovs/openvswitch-2.8.5
abs_top_srcdir = /home/jsen/ovs/openvswitch-2.8.5
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/jsen/ovs/openvswitch-2.8.5/build-aux/install-sh
...
ALL_LOCAL = dist-hook-git config-h-check printf-check static-check \
	...
	$(am__append_11) $(am__append_50) cxx-check \
...
CLEANFILES = all-distfiles all-gitfiles missing-distfiles distfiles \
	...
	ovsdb/ovsdb-dot vtep/vtep-ctl.8 vtep/ovs-vtep $(am__append_53) \
...
lib_libopenvswitch_la_SOURCES = lib/aes128.c lib/aes128.h \
	...
	$(am__append_26) $(am__append_27) $(am__append_29)
nodist_lib_libopenvswitch_la_SOURCES = lib/dirs.c lib/vswitch-idl.c \
	lib/vswitch-idl.h $(am__append_28)
