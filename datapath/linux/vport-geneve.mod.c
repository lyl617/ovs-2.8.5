...
__attribute__((section("__versions"))) = {
	...
	{ 0x367023c7, __VMLINUX_SYMBOL_STR(ovs_geneve_fill_metadata_dst) },
	{ 0x9d51b7db, __VMLINUX_SYMBOL_STR(rpl_geneve_xmit) },
	...
	{ 0xc8b9c862, __VMLINUX_SYMBOL_STR(rpl_geneve_dev_create_fb) },
...
MODULE_INFO(srcversion, "B4255075C532C2F7C1738F2");
